import { asyncPersonalRoutes, constantRoutes } from '@/router'
  ...
  actions: {
    generateRoutes({ commit }, nodes) {
      return new Promise(resolve => {
        const accessedRouters = filterAsyncRoutes(asyncPersonalRoutes, nodes)
...
export default personal_permission
