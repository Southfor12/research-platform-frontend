<template>
  ...
  >
    ...
    <h2 style="text-align: center; background-color: aliceblue; padding: 20px">
      所提供保护动物基本信息
    </h2>
    ...
    <el-form :model="form" label-width="120px">
      ...
      <h2 style="text-align: center; background-color: aliceblue; padding: 20px">复苏后处理方案</h2>
      <el-row>
        <el-form-item label="鉴定联系人">
          <el-input v-model="form.identifier_name" placeholder=""></el-input>
        </el-form-item>

        <el-form-item label="方案">
          <el-select v-model="form.scheme" placeholder="请选择方案">
            <el-option label="鉴定" value="鉴定"></el-option>
            <el-option label="剪样" value="剪样"></el-option>
            <el-option label="纯合后代" value="纯合后代"></el-option>
          </el-select>
        </el-form-item>

        <el-col :span="12">
          <el-form-item label="预计提交时间：">
            <el-date-picker
        ...
        <el-col :span="12">
          <el-form-item label="接收人">
            <el-input v-model="form.receiver_name" placeholder="请输入接收人姓名"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
      ...
      <el-row>
        <el-col>
          <el-form-item label="复苏信息：">
            <el-input
              v-model="form.awake_info"
              type="textarea"
              size="big"
              :rows="7"
              placeholder="请输入冻存信息"
...
<script>
import { buyTechOrderRevive } from '@/api/order';
...
export default {
  ...
  methods: {
    ...
    submit() {
      ...
      buyTechOrderRevive(this.form).then((res) => {
