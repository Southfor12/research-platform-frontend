  ...
  >
    ...
    <el-form :model="form" label-width="120px">
      ...
      <el-form-item label="日龄：">
        <el-input v-model="form.age" placeholder="请输入基因名称"></el-input>
      </el-form-item>

      <h2 style="text-align: center; background-color: aliceblue; padding: 20px">净化后处理方案</h2>
      <el-row>
      ...
      <el-row>
        <el-col>
          <el-form-item label="进化信息：">
            <el-input
              v-model="form.clear_info"
              type="textarea"
              size="big"
              :rows="7"
              placeholder="请输入冻存信息"
...
import { buyTechOrderPurify } from '@/api/order';
export default {
  data() {
    return {
      form: {
  ...
  methods: {
    ...
    submit() {
      ...
      buyTechOrderPurify(this.form).then((res) => {
