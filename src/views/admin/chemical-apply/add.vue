<template>
  ...
  >
    <el-form ref="form" :model="form" label-width="100px">
      <div style="border: 1px solid #efefef; border-radius: 10px; padding-top: 18px; margin: 18px 0">
...
<script>
import { addChemicalBooking, chemicalBookingMoney } from '@/api/chemical';
...
export default {
  ...
  methods: {
    ...
    returnToList() {
      this.$router.push({ path: '/personal/chemical-apply/list' });
    },
  },
};
</script>
