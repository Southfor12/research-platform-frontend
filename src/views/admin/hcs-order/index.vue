<template>
  ...
  >
    <el-form :inline="true" :model="queryForm">
      ...
      <el-form-item v-if="checkNode('add_hcs_order')" class="right">
    ...
    <el-table :header-cell-style="{ background: '#fafafa' }" :data="list" style="width: 100%">
      ...
      <el-table-column v-if="checkNode('audit_hcs_order')" width="180" label="操作">
        <template slot-scope="scope">
          <div class="bottom-10">
            <div class="top-10">
              <el-button
          ...
          <div class="bottom-10">
            ...
            >
            <el-button
              v-if="checkNode('audit_hcs_order') && scope.row.status === 1"
              size="mini"
              type="success"
              plain
          ...
          <div>
            <el-button
              v-if="checkNode('audit_hcs_order') && scope.row.status === 0"
              size="mini"
              type="danger"
              plain
...
export default {
  ...
  methods: {
    ...
    toAdd(id = '') {
      if (!id) {
        this.$router.push({ path: '/hcs-order/add' });
      } else {
        this.$router.push({ path: '/hcs-order/edit/' + id });
      }
    },
    chargeChange(value) {
