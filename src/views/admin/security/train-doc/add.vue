  ...
  >
    <el-form ref="form" :model="form" :rules="rules" label-width="150px">
      ...
      <el-form-item label="附件" v-if="form.type == 2 || form.type == 3">
        <el-card v-if="form.type == 2 && percent === 0" shadow="never" class="edl-upload-card">
          <el-upload
            class="img-uploader"
            name="edianlaiImg"
            accept=".mp4"
        ...
        <span v-if="percent > 0" class="bottom-30">视频上传中</span>
        <el-progress
          v-if="percent > 0"
          :text-inside="true"
          :stroke-width="26"
...
export default {
  ...
  methods: {
    ...
    returnToList() {
      this.$router.push({ path: '/train-doc/list' });
    },
  },
};
</script>
