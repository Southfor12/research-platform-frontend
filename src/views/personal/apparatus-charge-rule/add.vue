        ...
        <template slot="title">
          <div style="width: 100%; display: flex">
            ...
            <div style="display: inline-block; width: 50%; text-align: right; padding-right: 15px">
              <el-button size="mini" @click.stop="toAddTypeItem(false, item.id)"
                >添加计费项</el-button
              >
              <el-button size="mini" type="primary" @click.stop="toAddType(item)">修改</el-button>
              <el-button size="mini" type="danger" @click.stop="toDeleteType(item)">删除</el-button>
            </div>
          </div>
        </template>
          ...
          <el-table-column label="操作">
            <template slot-scope="scope">
              <el-button
                ...
                >修改</el-button
              ><br />
              <el-button size="mini" type="danger" @click.stop="toDeleteTypeItem(scope.row)"
                >删除</el-button
              >
            </template>
          </el-table-column>
...
export default {
  ...
  methods: {
    ...
    returnToList() {
      this.$router.push({ path: '/personal/apparatus-charge-rule/list' });
    },
  },
};
</script>
