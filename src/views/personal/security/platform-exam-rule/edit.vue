  ...
  >
    <el-form ref="form" :model="form" :rules="rules" label-width="150px">
      ...
      <el-form-item label="单选题抽考数量" prop="single_choose_num">
        <el-input-number size="small" :min="0" :precision="0" v-model="form.single_choose_num" />
      </el-form-item>
      <el-form-item label="多选题抽考数量" prop="multi_choose_num">
        <el-input-number size="small" :min="0" :precision="0" v-model="form.multi_choose_num" />
      </el-form-item>
      <el-form-item label="判断题抽考数量" prop="check_num">
        <el-input-number size="small" :min="0" :precision="0" v-model="form.check_num" />
      </el-form-item>
      ...
      >
        <el-row :gutter="20">
          <el-col :span="12"><el-slider v-model="form.pass_rate"></el-slider></el-col>
          <el-col :span="2">{{ form.pass_rate }}%</el-col>
        </el-row>
      </el-form-item>
      <el-form-item label="规章制度学习时间" prop="information_time">
        <el-input-number size="small" :min="0" :precision="0" v-model="information_time" />
        分钟
      </el-form-item>
      <el-form-item label="学习资料学习时间" prop="learning_time">
        <el-input-number size="small" :min="0" :precision="0" v-model="learning_time" />
        分钟
      </el-form-item>
      <el-form-item>
...
<script>
import { platformInfo, updateExamConfig } from '@/api/platform';
...
export default {
  ...
  methods: {
    ...
    returnToList() {
      this.$router.push({ path: '/personal/platform-exam-rule/list' });
    },
  },
};
</script>
