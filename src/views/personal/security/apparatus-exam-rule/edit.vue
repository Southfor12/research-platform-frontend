  ...
  >
    <el-form ref="form" :model="form" :rules="rules" label-width="150px">
      ...
      <!-- <el-form-item label="规章制度学习时间" prop="information_time">
            <el-input-number size="small" :min="0" :precision="0" v-model="information_time" /> 分钟
        </el-form-item>
        <el-form-item label="学习资料学习时间" prop="learning_time">
            <el-input-number size="small" :min="0" :precision="0" v-model="learning_time" /> 分钟
        </el-form-item> -->
      <el-form-item>
...
export default {
  ...
  methods: {
    ...
    returnToList() {
      this.$router.push({ path: '/personal/apparatus-exam-rule/list' });
    },
  },
};
</script>
