    ...
    <el-form ref="form" :model="form" :rules="rules" label-width="150px">
      ...
      <el-form-item label="选项" prop="singleAnswer" v-if="form.type === 1">
        <el-radio-group v-model="form.singleAnswer">
          <el-radio label="A"
            >A. <el-input v-model="form.a" size="small" class="max-width-200"
          /></el-radio>
          <el-radio label="B"
            >B. <el-input v-model="form.b" size="small" class="max-width-200"
          /></el-radio>
          <br />
          <el-radio label="C"
            >C. <el-input v-model="form.c" size="small" class="max-width-200"
          /></el-radio>
          <el-radio label="D"
            >D. <el-input v-model="form.d" size="small" class="max-width-200"
          /></el-radio>
        </el-radio-group>
      </el-form-item>
      ...
      <el-form-item label="选项" v-if="form.type === 3">
        <el-checkbox-group v-model="form.checkAnswer">
          ...
          <br />
          <el-checkbox label="E"
            >E. <el-input v-model="form.e" size="small" class="max-width-200"
          /></el-checkbox>
        </el-checkbox-group>
...
export default {
    ...
    return {
      ...
      rules: {
        name: [
          ...
          { min: 2, message: '长度至少 2个字', trigger: 'blur' },
        ],
  ...
  methods: {
    getInfo() {
      ...
      if (this.form.id) {
        examQuestionInfo({ id: this.form.id }).then((response) => {
          if (response.status !== 200) {
            ...
            if (this.form.apparatus_id) {
              apparatusInfo({ id: this.form.apparatus_id }).then((res) => {
                if (res.status === 200) {
    ...
    returnToList() {
      this.$router.push({ path: '/personal/exam-question/list' });
    },
  },
};
</script>
